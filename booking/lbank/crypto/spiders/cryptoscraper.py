...
class CryptoscraperSpider(scrapy.Spider):
    ...
    async def parse(self, response,p):
        ...
        async with async_playwright() as pw:
            ...
            await page.wait_for_timeout(10000)
            while True:
                xpath = '//ul[@class="index_ul__qih3J"]//div[@class="index_tradeTableItem__L6Z9U"]//span[contains(@style, "color: rgb(224, 49, 79)")]'
                elements_amount = await page.query_selector_all(xpath)
                #print(elements_amount)
                
                xpath2 = '//ul[@class="index_ul__qih3J"]//div[@class="index_tradeTableItem__L6Z9U"]//span[contains(@style, "color: rgb(63, 209, 185)")]'
