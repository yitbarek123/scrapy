...
class MySQLPipeline:
    ...
    def process_item2(self, item, spider):
        ...
        try:
            ...
            for d in data:
                t=d[3]
                l=t.split(":")
                tm=self.watch_time_to_unix_timestamp(int(l[0]),int(l[1]),int(l[2]))
                l=[]
                l.append(d[0])
                l.append(d[1])
                l.append(d[2])
            ...
            #bulk_data=data
            columns = ['tradetype', 'price','amount','time']
    ...
    def watch_time_to_timestamp(hours, minutes, seconds):
        # Create a timedelta object with the provided hours, minutes, and seconds
        watch_time = timedelta(hours=hours, minutes=minutes, seconds=seconds)
        ...
        # Subtract the watch time from the current time to get the timestamp
    ...
    def process_item(self, item, spider):
        ...
        try:
            ...
            if len(bulk_data)>0:
                ...
                columns = ['amount','total','price','time','tradetype']
