...
class CryptoscraperSpider(scrapy.Spider):
    ...
    async def parse(self, response,p):
        ...
        async with async_playwright() as pw:
            ...
            while True:
                xpath = '//body//li[@class="w-[30%] text-left t3UMhdLTbuvvf6XjWeTf" or @class="text-secondaryText text-right w-[35%] mr-2" or @class="text-secondaryText text-right w-[35%]"]'
                elements_amount = await page.query_selector_all(xpath)
                
                xpath2 = '//body//li[@class="w-[30%] text-left iM4qYuTmSKgPwRPj1yPH" or @class="text-secondaryText text-right w-[35%] mr-2" or @class="text-secondaryText text-right w-[35%]"]'
                #xpath = '//body//li[@class="w-[30%] text-left t3UMhdLTbuvvf6XjWeTf" or @class="text-secondaryText text-right w-[35%] mr-2" or @class="text-secondaryText text-right w-[35%]"]'
