...
class CryptoscraperSpider(scrapy.Spider):
    name = "cryptoscraper"
    allowed_domains = ["www.bitstamp.com"]
    start_urls = ["https://www.bitstamp.net/trade/btcusdt/"]
    ...
    def start_requests(self):
        ...
        for p in ps:
            yield scrapy.Request("https://www.bitstamp.net/trade/"+p,meta={'playwright':True},cb_kwargs={'p': p})
            print(ps)
    ...
    async def parse(self, response,p):
        ...
        async with async_playwright() as pw:
            ...
            await page.wait_for_timeout(10000)
            while True:
                xpath = '//div[@class="ob-asks"]//span[@class="orderbook-table__cell orderbook-row__ask-ask" or @class="orderbook-table__cell orderbook-row__ask-value orderbook-table__cell--value" or @class="orderbook-table__cell orderbook-row__ask-amount"]'
                ...
                for element in elements_amount:
                    ...
                    #if ":" in text_contentt:
                    #    continue
                    if "" == text_contentt and "0" != text_contentt:
                        continue
