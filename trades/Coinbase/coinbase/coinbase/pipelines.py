...
class MySQLPipeline:
    ...
    def watch_time_to_unix_timestamp(self, hours, minutes, seconds,current_time):
        ...
        unix_timestamp = int(target_time)

        return unix_timestamp

    def hms_to_timestamp(self,hours, minutes, seconds,ct):
        # Calculate the total seconds from the provided hours, minutes, and seconds
        total_seconds = hours * 3600 + minutes * 60 + seconds

        # Get the current time in seconds since the epoch
        current_time_seconds = ct
    ...
    def process_item(self, item, spider):
        ...
        try:
            ...
            if len(bulk_data)>0:
                columns = ['amount', 'price', 'tradetype','time']
